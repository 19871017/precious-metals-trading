...
async function setupAgent() {
  ...
  try {
    ...
    const result1 = await client.query(
      ...
      ['AG001', 1, 'agent001', passwordHash, '测试总代理', '13800138001']
    );

    console.log('✓ 总代理账号创建成功:', result1.rows[0]);
    ...
    const result2 = await client.query(
      ...
      RETURNING id, agent_code, username, real_name`,
      ['AG002', 2, result1.rows[0].id, 'agent002', passwordHash, '测试分代理', '13800138002']
    );

    console.log('✓ 分代理账号创建成功:', result2.rows[0]);
